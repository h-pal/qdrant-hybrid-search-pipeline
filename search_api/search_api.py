...
def search_ads(request: SearchRequest):
    ...
    try:
        ...
        rerank_candidates = 25  # Return top 25 for reranking
        PREFETCH_LIMIT = 50     # Fetch 50 from each index for better fusion
            ...
            prefetch=[
                models.Prefetch(
                    ...
                    params=models.SearchParams(
                        hnsw_ef=64,  # Higher accuracy with gRPC speed
                        exact=False
                    )
                ),
                models.Prefetch(
